			...
			<div class="container">
				<section>
					...
					<form method="POST"
						...
						<div class="mb-3">
                        						  <label for="exampleFormControlInput1" class="form-label">C&oacute;digo</label>
                        						  <input name="pais"
                        						  	readonly="readonly"
                        						  	value="<%=producto.getPais()%>"
                        						  	type="text" class="form-control" id="exampleFormControlInput1" maxlength="7">
                        						</div>
